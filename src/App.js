      ...
      <div className="App">
        <div className="App-header">
          ...
          <div style={{padding: '50px', width: '80%'}}>
            ...
            <p>Ethan is a Full-Stack web-developer proficient in Ruby on Rails and JavaScript with over three years of experience and growth at a Fortune 500 company.  Beginning with his childhood, including several years on a competitive LEGO Robotics Team, he developed a natural affinity for problem solving and for building both creatively and as directed. <br/><br/> After discovering a love of traditional logic as an undergrad through the works of Aristotle, Ethan began a journey into the realm of coding.  With a voracious appetite for news and entertainment media, consumer culture and IP policy, he enjoys exploring the ways in which entire, diverse universes can be constructed upon the building blocks of logic and code.</p>
          </div>
        </div>
